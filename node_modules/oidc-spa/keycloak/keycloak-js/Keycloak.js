...
const isAmong_1 = require("../../tools/tsafe/isAmong");
...
const homeAndRedirectUri_1 = require("../../core/homeAndRedirectUri");
/**
...
class Keycloak {
    ...
    get realmAccess() {
        ...
        (0, assert_1.assert)(tokens !== undefined);
        (0, assert_1.assert)((0, assert_1.is)(tokens.decodedIdToken_original));
    ...
    get sessionId() {
        ...
        (0, assert_1.assert)(typeof sid === "string");
        return sid;
    }
    /**
     * @private Undocumented.
