...
import { decodeProtectedHeader, jwtVerify, createLocalJWKSet, errors, importJWK, calculateJwkThumbprint, base64url } from "../vendor/server/jose.mjs";
    ...
    const validateAndDecodeAccessToken = async (params) => {
        ...
        validation: {
            ...
            validate_DPoP: {
                ...
                const expectedAth = base64url.encode(new Uint8Array(await globalThis.crypto.subtle.digest("SHA-256", new TextEncoder().encode(params.accessToken))));
                if (ath !== expectedAth) {
                    return id({
                        isSuccess: false,
                        errorCause: "validation error",
