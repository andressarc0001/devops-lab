...
export function resolveCandidate({ root, subDirectories, filenames }) {
...
export function resolvePackageFile(packageName, segments) {
    const pkgPath = require.resolve(`${packageName}/package.json`);
    return path.resolve(path.dirname(pkgPath), ...segments);
}
export function normalizeAbsolute(filePath) {
...
export function normalizeRequestPath(id) {
    let requestPath = id;
