import { MagicString } from "../vendor/build-runtime/magic-string.mjs";
import { babelParser, babelTraverse, babelTypes as t } from "../vendor/build-runtime/babel.mjs";
...
export function transformCreateFileRoute(params) {
    ...
    babelTraverse(ast, {
        ImportDeclaration(path) {
            ...
            if (sourceValue === "@tanstack/react-router") {
                if (path.node.specifiers.some(specifier => t.isImportSpecifier(specifier) &&
...
//# sourceMappingURL=transformTanstackRouterCreateFileRoute.mjs.map
