...
import { OidcInitializationError } from "../../core/OidcInitializationError.mjs";
...
import { enableStateDataCookie } from "../../core/StateDataCookie.mjs";
export function createOidcSpaUtils(params) {
    ...
    function useOidc(params) {
        ...
        const { hasResolved, value: oidcCoreOrInitializationError } = dOidcCoreOrInitializationError.getState();
        check_assertion: {
        ...
        const [hasHydrated, setHasHydratedToTrue] = useReducer(() => true, assert_params !== undefined ? undefined : false);
        useEffect(() => {
    ...
    const prModuleCore = !isBrowser ? undefined : import("../../core/index.mjs");
    const bootstrapOidc = (getParamsOfBootstrapOrDirectValue) => {
        ...
        (async () => {
            ...
            switch (paramsOfBootstrap.implementation) {
                case "mock":
                    {
                        const { createMockOidc } = await import("../../core/createMockOidc.mjs");
    ...
    function createFunctionMiddlewareServerFn(params) {
        return async (options) => {
            ...
            const { extractRequestAuthContext } = await import("../../server/extractRequestAuthContext.mjs");
            ...
            if (!requestAuthContext.isWellFormed) {
                throw createError({
                    code: 400,
                    wwwAuthenticateResponseHeaderValue: "Bearer error=\"invalid_request\", error_description=\"Malformed or unsupported request\"",
            ...
            const resultOfValidate = await validateAndGetAccessTokenClaims(requestAuthContext.accessTokenAndMetadata);
