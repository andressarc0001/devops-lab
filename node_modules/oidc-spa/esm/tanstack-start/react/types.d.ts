...
export declare namespace UseOidc {
    ...
    type Oidc<DecodedIdToken> = (Oidc.NotReady & {
...
export declare namespace OidcFnMiddleware {
    type WithAutoLogin<AccessTokenClaims> = (params?: {
        assert?: "user logged in";
        hasRequiredClaims?: (params: {
            accessTokenClaims: AccessTokenClaims;
        }) => MaybeAsync<boolean | undefined>;
    ...
    type TanStackFnMiddleware<T> = FunctionMiddlewareAfterServer<{}, unknown, undefined, T, {}, undefined, undefined>;
}
export type OidcServerContext<AccessTokenClaims> = OidcServerContext.LoggedIn<AccessTokenClaims> | (OidcServerContext.NotLoggedIn & {
    accessTokenClaims?: never;
    accessToken?: never;
});
export declare namespace OidcServerContext {
    type NotLoggedIn = {
        isUserLoggedIn: false;
    };
    type LoggedIn<AccessTokenClaims> = {
        isUserLoggedIn: true;
        accessTokenClaims: AccessTokenClaims;
        accessToken: string;
    };
...
export declare namespace OidcRequestMiddleware {
    type WithAutoLogin<AccessTokenClaims> = (params?: {
        assert?: "user logged in";
        hasRequiredClaims?: (params: {
            accessTokenClaims: AccessTokenClaims;
    ...
    type TanstackRequestMiddleware<T> = RequestMiddlewareAfterServer<{}, undefined, T>;
}
export type ParamsOfBootstrap<AutoLogin, DecodedIdToken, AccessTokenClaims> = ParamsOfBootstrap.Real<AutoLogin> | ParamsOfBootstrap.Mock<AutoLogin, DecodedIdToken, AccessTokenClaims>;
export declare namespace ParamsOfBootstrap {
    ...
    type Mock<AutoLogin, DecodedIdToken, AccessTokenClaims> = {
        implementation: "mock";
...
export type OidcSpaUtils<AutoLogin, DecodedIdToken, AccessTokenClaims> = {
    bootstrapOidc: (params: GetterOrDirectValue<{
        process: {
            env: Record<string, string>;
        };
    }, ParamsOfBootstrap<AutoLogin, DecodedIdToken, AccessTokenClaims>>) => void;
    ...
    oidcFnMiddleware: AutoLogin extends true ? OidcFnMiddleware.WithAutoLogin<AccessTokenClaims> : OidcFnMiddleware<AccessTokenClaims>;
    oidcRequestMiddleware: AutoLogin extends true ? OidcRequestMiddleware.WithAutoLogin<AccessTokenClaims> : OidcRequestMiddleware<AccessTokenClaims>;
}) & (AutoLogin extends true ? {} : {
...
export type ValidateAndGetAccessTokenClaims<AccessTokenClaims> = (params: import("../../server/types").ValidateAndDecodeAccessToken.Params) => Promise<ValidateAndGetAccessTokenClaims.ReturnType<AccessTokenClaims>>;
export declare namespace ValidateAndGetAccessTokenClaims {
    type ReturnType<AccessTokenClaims> = ReturnType.Success<AccessTokenClaims> | ReturnType.Errored;
    namespace ReturnType {
        type Success<AccessTokenClaims> = {
            isSuccess: true;
            accessTokenClaims: AccessTokenClaims;
            accessToken: string;
        };
