...
export function browserRuntimeFreeze(params) {
...
function freezeBrowserRuntime(params) {
    const { excludedApiNames } = params;
    const createWriteError = (params) => {
    ...
    const definePropertyInterceptors = [];
    {
    ...
    for (const apiName of [
        ...
        crypto_subtle: {
            ...
            }
            {
                const o = crypto;
                const p = "subtle";
                const createWriteError_local = () => createWriteError({ target: "window.crypto.subtle", apiName });
        ...
        service_worker: {
            ...
            const createWriteError_local = () => createWriteError({ target: `window.navigator.${p}`, apiName });
            Object.defineProperty(o, p, {
                configurable: false,
                enumerable: true,
                get: () => original,
        ...
        Function: {
            ...
            };
            {
                ...
                const p = pName;
                const createWriteError_local = () => createWriteError({
        ...
        if ("prototype" in original) {
            for (const propertyName of Object.getOwnPropertyNames(original.prototype)) {
                ...
                const createWriteError_local = () => createWriteError({ target: `window.${apiName}.prototype.${p}`, apiName });
                Object.defineProperty(o, p, {
                    enumerable: pd.enumerable,
                    configurable: false,
                    ...("value" in pd
            ...
            for (const propertyName of Object.getOwnPropertyNames(original)) {
                ...
                const o = original;
                const p = propertyName;
                const createWriteError_local = () => createWriteError({ target: `window.${apiName}.${propertyName}`, apiName });
                Object.defineProperty(o, p, {
                    enumerable: pd.enumerable,
                    configurable: false,
                    ...("value" in pd
        ...
        }
        {
            const o = window;
            const p = apiName;
            const createWriteError_local = () => createWriteError({ target: `window.${apiName}`, apiName });
            Object.defineProperty(o, p, {
                configurable: false,
                enumerable: true,
                get: () => original,
...
//# sourceMappingURL=earlyInit_browserRuntimeFreeze.mjs.map
