...
import { noUndefined } from "../tools/tsafe/noUndefined.mjs";
import { createStatefulEvt } from "../tools/StatefulEvt.mjs";
import { Deferred } from "../tools/Deferred.mjs";
import { addOrUpdateSearchParam, getAllSearchParams } from "../tools/urlSearchParams.mjs";
import { getIsOnline } from "../tools/getIsOnline.mjs";
import { setStateDataCookieIfEnabled } from "./StateDataCookie.mjs";
const globalContext = {
...
export function createLoginOrGoToAuthServer(params) {
    const { configId, oidcClientTsUserManager, transformUrlBeforeRedirect, getExtraQueryParams, getExtraTokenParams, homeUrl, stateUrlParamValue_instance, evtInitializationOutcomeUserNotLoggedIn, log } = params;
    ...
    async function loginOrGoToAuthServer(params) {
        ...
        return oidcClientTsUserManager
            ...
            assert(false, `This is a bug in oidc-spa (loginOrGoToAuthServer), please report: ${error.message}`);
        });
    }
...
//# sourceMappingURL=loginOrGoToAuthServer.mjs.map
