...
export const evtIsThereMoreThanOneInstanceThatCantUserIframes = createStatefulEvt(() => sessionStorage.getItem(SESSION_STORAGE_KEY) !== null);
let count = 0;
...
//# sourceMappingURL=instancesThatCantUseIframes.mjs.map
