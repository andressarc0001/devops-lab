...
function createOidcSpaUtils(params) {
    ...
    evtInvalidSignature.pipe((0, evt_1.throttleTime)(3600000)).attach(async () => {
        const publicSigningKeys_new = await (async function callee(count) {
            ...
            (0, tsafe_1.assert)(paramsOfBootstrap.implementation === "real", "22933023");
        ...
        function getIsDpopPoofSeenRecordIfNotSeen(params) {
            ...
            }
            {
                ...
                if (timeSeenByDpopProofId.size > 50000) {
                    ...
                    (0, tsafe_1.assert)(firstEntry !== undefined, "3922304");
    ...
    const validateAndDecodeAccessToken = async (params) => {
        const paramsOfBootstrap = await dParamsOfBootstrap.pr;
        ...
        validation: {
            if (paramsOfBootstrap.implementation === "mock") {
                tsafe_1.assert;
                decodedAccessToken_original = (0, decodeJwt_1.decodeJwt)(params.accessToken);
                try {
            ...
            let alg;
            {
                let header;
                try {
                    header = (0, jose_1.decodeProtectedHeader)(params.accessToken);
                }
                catch {
                    return (0, tsafe_1.id)({
                        isSuccess: false,
            ...
            (0, tsafe_1.assert)(publicSigningKeys !== undefined, "3304483302");
            ...
            try {
                const verification = await (0, jose_1.jwtVerify)(params.accessToken, publicSigningKeys.keyResolver, {
                    algorithms: [alg]
                });
            ...
            validate_DPoP: {
                ...
                let dpopHeader;
                try {
                    dpopHeader = (0, jose_1.decodeProtectedHeader)(params.dpopProof);
                }
                catch {
                    return (0, tsafe_1.id)({
                        isSuccess: false,
                ...
                try {
                    ...
                    const verification = await (0, jose_1.jwtVerify)(params.dpopProof, key, {
                        algorithms: [dpopAlg],
                        typ: "dpop+jwt"
                    });
                    ...
                    (0, tsafe_1.assert)(error instanceof Error, "34022849313");
                    return (0, tsafe_1.id)({
                        isSuccess: false,
                        errorCause: "validation error",
                ...
                const expectedAth = jose_1.base64url.encode(new Uint8Array(await globalThis.crypto.subtle.digest("SHA-256", new TextEncoder().encode(params.accessToken))));
                if (ath !== expectedAth) {
                    return (0, tsafe_1.id)({
                        isSuccess: false,
                        errorCause: "validation error",
        ...
        if (decodedAccessTokenSchema === undefined) {
            ...
            try {
                ...
                (0, tsafe_1.assert)(error instanceof Error, "887302013");
                return (0, tsafe_1.id)({
                    isSuccess: false,
                    errorCause: "validation error",
                    debugErrorMessage: [
...
async function fetchPublicSigningKeys(params) {
    ...
    const { jwks_uri } = await (async () => {
        ...
        if (response instanceof Error || !response.ok) {
            throw new Error(`Failed to fetch openid configuration of the issuerUri: ${issuerUri} (${url}): ${response instanceof Error ? response.message : response.statusText}`);
        }
        let data;
        try {
